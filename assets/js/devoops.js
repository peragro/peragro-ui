...
function SparklineLoop(){
	if($("#sparklinetd").sparkline){
		$("#sparklinetd").sparkline(sparklinetd(), {
			type: 'bar',
			height: '40',
			barWidth: 7,
			barSpacing: 2,
	...
	if($("#sparklinemd").sparkline){
		$("#sparklinemd").sparkline(sparklinemd(), {
			type: 'bar',
			height: '40',
			barWidth: 7,
			barSpacing: 2,
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		ajax_url = 'ajax/loader.php?page=dashboard';
	}
